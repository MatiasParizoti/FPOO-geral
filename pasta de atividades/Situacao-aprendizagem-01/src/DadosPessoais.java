public class DadosPessoais {
		...
		public void setNome(String nome) {
			if(nome.isEmpty()) {
				System.out.println("NOME É OBRIGATÓERIO");
				System.exit(0);
			}else {
		...
		public void setSobreNome(String sobreNome) {
			if(sobreNome.isEmpty()) {
				System.out.println("SOBRENOME É OBRIGATÓERIO");
				System.exit(0);
			}else {
		...
		public void setDataNascimento(String dataNascimento) {
			if(dataNascimento.isEmpty()) {
				System.out.println("DATA É OBRIGATÓERIO:");
				System.exit(0);
			}else {
		...
		public void setGenero(String genero) {
			if(genero.isEmpty()) {
				System.out.println("GENERO É OBRIGATÓERIO:");
				System.exit(0);
			}else {
